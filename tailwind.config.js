...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        "ij-shadow-s": "var(--shadow-s)",
        "ij-shadow-m": "var(--shadow-m)",
        "ij-shadow-l": "var(--shadow-l)",
        "ij-shadow-base": "var(--shadow-base)",
        "ij-shadow-mult": "var(--shadow-mult)",
        "ij-shadow-focus": "var(--shadow-focus)",
      },
    },
    plugins: [],
  },
